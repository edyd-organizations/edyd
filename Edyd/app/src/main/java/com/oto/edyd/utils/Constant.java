...
public  class Constant {
    ...
    //网络地址
    public final static String ENTRANCE_PREFIX = "http://120.24.236.223/api/v1.1/"; //接口前缀地址
    //public final static String ENTRANCE_PREFIX = "http://www.edyd.cn/api/v1.1/"; //接口前缀地址
