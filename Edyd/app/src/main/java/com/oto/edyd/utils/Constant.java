...
public class Constant {
   ...
   // public final static String ENTRANCE_PREFIX = "http://www.edyd.cn/api/v1.0/"; //接口前缀地址
    ...
    public final static String CMB_CALLBACK_ADDRESS = "&ExpireTimeSpan=3600&MerchantUrl=http://120.24.236.223/callback/updateBillStatus.json";
    //public final static String CMB_CALLBACK_ADDRESS = "&ExpireTimeSpan=3600&MerchantUrl=http://www.edyd.cn/callback/updateBillStatus.json";
